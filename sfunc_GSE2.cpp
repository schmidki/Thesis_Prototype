 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Feb 20 10:12:27 2024
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfunc_GSE2
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            1
/* Input Port  0 */
#define IN_PORT_0_NAME        gse_input
#define INPUT_0_WIDTH         1
#define INPUT_DIMS_0_COL      88
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       gse_output_plain
#define OUTPUT_0_WIDTH        1
#define OUTPUT_DIMS_0_COL     4096
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       gse_output_cipher
#define OUTPUT_1_WIDTH        1
#define OUTPUT_DIMS_1_COL     88
...
#define SOURCEFILES           "__SFB__LIB_PATH M:\MATLAB\ECOM_Encryption__SFB__INC_PATH M:\customlibs\cryptopp890__SFB__INC_PATH M:\MATLAB\ECOM_Encryption__SFB__cryptlib.lib"
...
extern void sfunc_GSE2_Outputs_wrapper(const uint8_T *gse_input,
...
{
    const uint8_T *gse_input = (uint8_T *) ssGetInputPortRealSignal(S, 0);
    uint8_T *gse_output_plain = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
    uint8_T *gse_output_cipher = (uint8_T *) ssGetOutputPortRealSignal(S, 1);

    sfunc_GSE2_Outputs_wrapper(gse_input, gse_output_plain, gse_output_cipher);
